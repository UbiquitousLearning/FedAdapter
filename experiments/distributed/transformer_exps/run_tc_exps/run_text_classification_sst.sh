# cd /home/cdq/FedNLP/experiments/distributed/transformer_exps/run_tc_exps/ && conda activate fednlp && sh run_text_classification_sst.sh FedAvg "niid_quantity_clients=30_beta=1.0" 0.1 0.1 10000 5
FL_ALG=$1
PARTITION_METHOD=$2
C_LR=$3
S_LR=$4
